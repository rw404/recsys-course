...
// fixed level camera; vary only Astra yaw. Player hidden far away for clarity.
const CAM='lcx=7.0&lcy=1.45&lcz=4.6&llx=2.6&lly=1.15&llz=1.2&lfov=44&lpx=30&lpz=30'
const yaws=[['lay0','lay=0.0'],['lay079','lay=0.79'],['lay157','lay=1.57'],['layneg079','lay=-0.79']]
for(const [name,q] of yaws){
  let ok=false
